        ...
        <table class="table table-dark table-hover">
            <thead>
                <tr>
                    ...
                    <td>
                        <h3>NOM</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-signature"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <td>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-dots-circle-horizontal" width="24" height="24"
                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <desc>Download more icon variants from https://tabler-icons.io/i/dots-circle-horizontal
                            </desc>
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                 ...
                 <td>" . $row['telefon'] . "</td>
                 <td>" . $row['gmail'] . "</td>
                 <td><a class='btn btn-primary' href='nou-proveidor.php?idproveidor=" . $row['idproveidor'] . "'>Editar</a>
                 <a class='btn btn-danger' href='scripts/delete-proveidor.php?idproveidor=" . $row['idproveidor'] . "'>Eliminar</a></td>
                 </tr>";
                }
                ?>
                <a href="nou-proveidor.php">Insertar nou proveidor</a>
